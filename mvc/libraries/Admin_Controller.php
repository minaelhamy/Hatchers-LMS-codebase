...
class Admin_Controller extends MY_Controller
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->data['hatchers_nav_left'] = [];
        $this->data['hatchers_nav_right'] = [];
        if ($this->db->table_exists('hatchers_nav_items')) {
            $this->data['hatchers_nav_left'] = $this->hatchers_nav_item_m->get_order_by_hatchers_nav_item([
                'location' => 'left',
                'active'   => 1
            ]);
            $this->data['hatchers_nav_right'] = $this->hatchers_nav_item_m->get_order_by_hatchers_nav_item([
                'location' => 'right_ai',
                'active'   => 1
            ]);
        }
