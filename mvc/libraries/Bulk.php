...
class Bulk
{
    ...
    protected $username;
    protected $password;
    protected string $url = 'https://bulksms.vsms.net/eapi/submission/send_sms/2/2.0';
    ...
    {
        return bin2hex(mb_convert_encoding((string) $string, "UTF-16", "UTF-8"));
    }
    ...
    function make_post_body( $post_fields )
    {
        ...
        foreach ( $post_fields as $key => $value ) {
            $post_body .= urlencode((string) $key) . '=' . urlencode((string) $value) . '&';
        }
        return rtrim($post_body, '&');
    }
