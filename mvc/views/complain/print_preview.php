                        ...
                        <div class="studentProfile">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="singleItem">
                                    ...
                                    <div class="single_value">: <?=date('d M Y',strtotime((string) $user->dob))?></div>
                                </div>
                                <div class="singleItem">
                                    <div class="single_label"><?=$this->lang->line('complain_phone')?></div>
                                    <div class="single_value">: <?=$user->phone?></div>
                ...
                <div class="areaBottom">
                    <div class="bottomInfo">
                        <div class="singleItem">
                            ...
                            <div class="single_value">: <?=date("d M Y - h:i:s A",strtotime((string) $complain->create_date));?></div>
                        </div>
                        <div class="singleItem">
                            <div class="single_label"><?=$this->lang->line('complain_modify_date')?></div>
                            <div class="single_value">: <?=date("d M Y - h:i:s A",strtotime((string) $complain->modify_date));?></div>
                        </div>
                        <div class="singleItem">
                            <div class="single_label"><?=$this->lang->line('complain_complainer_name')?></div>
                            <div class="single_value">: <?=customCompute($createinfo) ? $createinfo->name : ''?></div>
                        </div>
                        <div class="singleItem">
                            <div class="single_label"><?=$this->lang->line('complain_complainer_role')?></div>
                            <div class="single_value">: <?=customCompute($createinfo) ? $createinfo->usertype : ''?></div>
                        </div>
                    </div>
