<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_sponsor')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
    ...
    echo "<div class='form-group' >";
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                echo form_dropdown("title", $titles, set_value("title", (($checked=='individual') ? $sponsor->title : '')), "id='title' class='form-control select2'");
                            ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="sponsor_person_name" name="sponsor_person_name" value="<?=set_value('sponsor_person_name', (($checked=='individual') ? $sponsor->name : ''))?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="organisation_name" name="organisation_name" value="<?=set_value('organisation_name', (($checked=='individual') ? $sponsor->organisation_name : ''))?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="sponsor_organisation_name" name="sponsor_organisation_name" value="<?=set_value('sponsor_organisation_name', (($checked=='organisation') ? $sponsor->name : ''))?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php echo form_dropdown("organisation_title", $titles, set_value("organisation_title", (($checked=='organisation') ? $sponsor->title : '')), "id='organisation_title' class='form-control select2'"); ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="contact_person_name" name="contact_person_name" value="<?=set_value('contact_person_name', (($checked=='organisation') ? $sponsor->organisation_name : ''))?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="email" name="email" value="<?=set_value('email', $sponsor->email)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="phone" name="phone" value="<?=set_value('phone', $sponsor->phone)?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("country", $country, set_value("country", $sponsor->country), "id='country' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_sponsor")?>" >
                        </div>
                    </div>
                </form>
            </div>
