                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('issue_classes')?></b> <a class="pull-right"><?=customCompute($classes) ? $classes->classes : ''?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('issue_section')?></b> <a class="pull-right"><?=customCompute($section) ? $section->section : ''?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("issue_issue_date")?> </span>: <?=date("d M Y", strtotime((string) $book->issue_date));?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("issue_due_date")?> </span>: <?=date("d M Y", strtotime((string) $book->due_date));?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("issue_return_date")?> </span>: 
                                            <?php
                                                if(!$book->return_date == "" && !empty($book->return_date)) {
                                                echo date("d M Y", strtotime((string) $book->return_date));
                                                }
                                            ?>
                                        </p>
                                    </div>
