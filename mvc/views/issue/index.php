                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td data-title="<?=$this->lang->line('issue_issue_date')?>">
                                                <?php echo date("d M Y", strtotime((string) $issue->issue_date)); ?>
                                            </td>
                                            <td data-title="<?=$this->lang->line('issue_due_date')?>">
                                                <?php echo date("d M Y", strtotime((string) $issue->due_date)); ?>
                                            </td>
                                            <td data-title="<?=$this->lang->line('issue_status')?>">
                                                <?php
                                                    $date = date("Y-m-d");
                                                    if(strtotime($date) > strtotime((string) $issue->due_date)) {
                                            ...
                                            <td data-title="<?=$this->lang->line('action')?>">
                                                ...
                                                ?>
                                                <?php
                                                    if (permissionChecker('issue_add') && permissionChecker('issue_edit') && (($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1))) {
                                                    if($issue->return_date == "" || empty($issue->return_date)) {
