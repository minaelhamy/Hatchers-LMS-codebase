                    ...
                    <?php
                        if(customCompute($exams)) {
                            ...
                            foreach ($exams as $exam) {
                                $checkbox = in_array($exam->examID, $checkexamArr);
                    ...
                    <?php
                        if(customCompute($markpercentages)) {
                            ...
                            foreach ($markpercentages as $markpercentage) {
                                $checkbox = in_array($markpercentage->markpercentageID, $checkmarkpercentageArr);
                                echo '<div class="col-sm-3">';
                                    echo '<div class="checkbox">';
                                        echo '<label>';
        ...
        <form class="form-horizontal mainmarktypeID" id="mainmarktypeID1" role="form" method="post">
            ...
            <fieldset class="setting-fieldset">
                ...
                <div class="row">
                    ...
                    if(customCompute($classes)) { foreach ($classes as $class) { $i++;
                        ...
                        echo '<div class="col-sm-3 '.$margintop.'">';
                            ...
                            if(customCompute($markpercentages)) {
                                ...
                                foreach ($markpercentages as $markpercentage) {
                                    $checkbox = in_array($markpercentage->markpercentageID, $checkclasspercentageArray);
                                    echo '<div class="checkbox">';
                                        echo '<label>';
        ...
        <form class="form-horizontal mainmarktypeID" id="mainmarktypeID2" role="form" method="post">
            ...
            <fieldset class="setting-fieldset">
                ...
                <div class="row">
                    ...
                    if(customCompute($exams)) { foreach ($exams as $exam) { $i++;
                        $checkbox  = in_array($exam->examID, $checkexamArr); 
                        $margintop = (($i>4) ? 'margintop' : '');
                        echo '<div class="col-sm-3 '.$margintop.'">';
                            echo '<div class="singlebox">';
                                ...
                                if(customCompute($markpercentages)) {
                                    ...
                                    foreach ($markpercentages as $markpercentage) {
                                        $checkbox = in_array($markpercentage->markpercentageID, $checkexampercentageArray);
                                        echo '<div class="checkbox">';
                                            echo '<label>';
                ...
                <div class="row">
                    ...
                    if(customCompute($classes)) { foreach ($classes as $class) { $i++;
                        ...
                        echo '<div class="col-sm-3 '.$margintop.'">';
                            ...
                            echo "<h4 class='singleboxheader'>".$class->classes."</h4>";
                            if(isset($subjects[$class->classesID]) && customCompute($subjects[$class->classesID])) {
            ...
            <fieldset class="setting-fieldset">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if(customCompute($classes)) { foreach($classes as $class) {
                            echo "<div class='classexamDiv'>";
                                echo "<h4 class='classexamheader'><i class='fa fa-arrow-right'></i> ".$class->classes."</h4>";
                                echo "<div class='row'>";
                                    if(customCompute($exams)) { $i=0;
                                        foreach ($exams as $exam) { $i++;
                                        $checkbox  = isset($checkclassexampercentageArr[$class->classesID][$exam->examID]);
                                        $margintop = (($i>4) ? 'margintop' : '');
                                        echo '<div class="col-sm-3 '.$margintop.'">';
                                            echo '<div class="singlebox">';
                        ...
                        if(customCompute($classes)) { foreach($classes as $class) {
                            echo "<div class='classexamDiv'>";
                                ...
                                echo "<div class='row'>";
                                    if(customCompute($exams)) { $i=0;
                                        foreach ($exams as $exam) { $i++;
                                        $checkbox  = isset($checkclassexamsubjectpercentageArr[$class->classesID][$exam->examID]);
                                        $margintop = (($i>4) ? 'margintop' : '');
                                        echo '<div class="col-sm-3 '.$margintop.'">';
                                            echo '<div class="singlebox">';
...
<script type="text/javascript">
    ...
    <?php if((isset($markpercentageArr[1]) && customCompute($markpercentageArr[1])) || (set_value('exams[]'))) { ?>
