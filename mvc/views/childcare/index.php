            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tbody>
                        <?php if(customCompute($drop_receive)) {$i = 1; foreach($drop_receive as $drop) { ?>
                            <tr>
                                ...
                                <td data-title="<?=$this->lang->line('drop_date')?>">
                                    <?=date('d M Y h:i:s A',strtotime((string) $drop->dropped_at)) ?>
                                </td>
                                <td data-title="<?=$this->lang->line('receive_date')?>">
                                    <?php if($drop->received_at) { echo date('d M Y h:i:s A',strtotime((string) $drop->received_at)); } ?>
                                </td>
