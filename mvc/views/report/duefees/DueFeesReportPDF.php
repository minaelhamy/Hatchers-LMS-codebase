<div class="box">
    ...
    <div class="box-body" style="margin-bottom: 50px;">
        <div class="row">
           ...
           <?php } ?>
                <div class="col-sm-12">
                <?php if(customCompute($getDueFeesReports)) { ?>
                        ...
                        <table class="table table-bordered table-responsive">
                            ...
                            <tbody>
                                <?php $totalDue = 0; $i = 0; foreach($getDueFeesReports as $getDueFeesReport) { if($sectionID > 0) { if(isset($students[$getDueFeesReport->studentID]) && $students[$getDueFeesReport->studentID]->srsectionID == $sectionID) { $i++;?>
                                        <tr>
                                            <td><?=$i?></td>
                                            <td><?=date('d M Y',strtotime((string) $getDueFeesReport->create_date))?></td>
                                ...
                                <tr>
                                    ...
                                    <td class="grand-total" colspan="<?=$colspan?>">
                                        <?=$this->lang->line('duefeesreport_grand_total')?> (<?=empty($siteinfos->currency_code) ? '0' : $siteinfos->currency_code?>)
                                    </td>
