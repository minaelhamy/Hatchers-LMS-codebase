...
<?php if(($gspayment == "INV-G-") || ($gspayment == "inv-g-")) { ?>
        ...
        <?php if(customCompute($globalpayments)) { ?>
            <div id="printablediv">
                <!-- form start -->
                <style type="text/css">
                            ...
                            <!-- <div class="row"> -->
                                ...
                                <div class="col-sm-12">
                                    <table class="table info">
                                        <tr>
                                            <td><b><?=$this->lang->line('searchpaymentfeesreport_invoice_number')?> : </b>INV-G-<?=customCompute($globalpayments) ? $globalpayments[0]->globalpaymentID : ''?></td>
                                            <td><b><?=$this->lang->line('searchpaymentfeesreport_clearance')?> : </b><?=customCompute($globalpayments) ? $globalpayments[0]->clearancetype : '' ?></td>
                                            <td><b><?=$this->lang->line('searchpaymentfeesreport_date')?> : </b> <?=customCompute($globalpayments) ? date('d M Y', strtotime((string) $globalpayments[0]->paymentdate)) : '' ?></td>
                                        </tr>
                                            <tr>
                                                <td><b><?=$this->lang->line('searchpaymentfeesreport_name')?> : </b> <?=customCompute($studentinfo) ? $studentinfo->srname : ''?></td>

                                                <td><b><?=$this->lang->line('searchpaymentfeesreport_classes')?> : </b> <?=customCompute($studentinfo) ? $studentinfo->srclasses  : ''?>, <b><?=$this->lang->line('searchpaymentfeesreport_roll')?> : </b> <?=customCompute($studentinfo) ? $studentinfo->srroll : ''?>, <b><?=$this->lang->line('searchpaymentfeesreport_section')?> : </b><?=customCompute($studentinfo) ? $studentinfo->srsection  : ''?></td>
                                                <td><b><?=$this->lang->line('searchpaymentfeesreport_group')?> : </b><?=isset($groups[$studentinfo->srstudentgroupID]) ? $groups[$studentinfo->srstudentgroupID] : '' ?></td>
                                            </tr>
                                        <tr>
                                ...
                                <div class="col-sm-12" style="margin-top:0px">
                                    <table id="example1" class="table">
                                        ...
                                        if(customCompute($globalpayments)) { foreach($globalpayments as $payment) { ?>
                                            <tr>
...
<?php } elseif (($gspayment == "INV-S-") || ($gspayment == "inv-s-")) { ?>
        ...
        <?php if(customCompute($singlepayments)) {?>
            <div id="printablediv">
                <section class="content invoice" >
                    ...
                    <div class="row invoice-info">
                        ...
                        <?php if(customCompute($studentinfo)) { ?>
                            <div class="col-sm-4 invoice-col" style="font-size: 16px;">
                            ...
                            <table class="table table-bordered product-style">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td data-title="<?=$this->lang->line('searchpaymentfeesreport_amount')?>">

                                            <?= $singlepayment->paymentamount !== null ? number_format($singlepayment->paymentamount, 2) : '0.00' ?></td>

                                            <td data-title="<?=$this->lang->line('searchpaymentfeesreport_weaver')?>">
                                                 <?= $singlepayment->weaver !== null ? number_format($singlepayment->weaver,2) : '0.00' ?>
                                            </td>
                                            <td data-title="<?=$this->lang->line('searchpaymentfeesreport_fine')?>">
                                            <?= $singlepayment->fine !== null ? number_format($singlepayment->fine,2) : '0.00' ?>
                                        </td>
                                            <td data-title="<?=$this->lang->line('searchpaymentfeesreport_sub_total')?>">
                                            <?=$singlepayment->paymentamount+$singlepayment->fine !== null ? number_format(($singlepayment->paymentamount+$singlepayment->fine),2): '0.00' ?></td>
                                            <?php 
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td><b><?= $paymentamount !== null ? number_format($paymentamount, 2) : '' ?></b></td>
                                        <td><b><?= $weaver !== null ? number_format($weaver, 2) : '0.00' ?></b></td>
                                        <td><b><?= $fine !== null ? number_format($fine, 2) : '0.00' ?></b></td>
                                        <td><b><?= $subtotal !== null ? number_format($subtotal, 2) : '0.00' ?></b></td>
                                    </tr>
                                </tfoot>
                            </table>
                            </div>
                        ...
                        <div class="col-sm-3 col-xs-12 pull-right">
                            <div class="well well-sm">
                                <p>
                                    ...
                                    <br>
                                    <?=$this->lang->line('searchpaymentfeesreport_date')?> : <?=date('d M Y', strtotime((string) $paymentDate))?>
                                </p>
                            </div>
                        </div>
