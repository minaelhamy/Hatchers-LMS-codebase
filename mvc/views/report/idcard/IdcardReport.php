                                ...
                                <td class="idcardreport-frontend">
                                    ...
                                    <div class="profile-view-dis">
                                        <?php if($usertypeID == 1) { ?>
                                            ...
                                            <div class="profile-view-tab">
                                                <p><span><b><?=$this->lang->line('idcardreport_dob')?></b> </span>: <?=date('d M Y',strtotime((string) $idcard->dob))?></p>
                                            </div>
                                            <div class="profile-view-tab">
                                                <p><span><b><?=$this->lang->line('idcardreport_jod')?></b> </span>: <?=date('d M Y',strtotime((string) $idcard->jod))?></p>
                                            </div>
                                            <div class="profile-view-tab">
