<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $pdf_preview_uri = base_url('studentfinereport/pdf/'.strtotime((string) $fromdate).'/'.strtotime((string) $todate));
            $xml_preview_uri = base_url('studentfinereport/xlsx/'.strtotime((string) $fromdate).'/'.strtotime((string) $todate));
            ...
            <div class="row">
                ...
                <?php if($fromdate != '' && $todate != '') { ?>
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <h5 class="pull-left"><?=$this->lang->line('studentfinereport_fromdate')?> : <?=date('d M Y',strtotime((string) $fromdate))?></h5>                         
                                <h5 class="pull-right"><?=$this->lang->line('studentfinereport_todate')?> : <?=date('d M Y',strtotime((string) $todate))?></h5>                        
                            </div>
                        </div>
                    </div>
                <?php } ?>
                                    ...
                                    <?php $total_fine = 0; $i=0; foreach($studentfines as $studentfine) { $i++;?>
                                        <tr>
                                            ...
                                            <td data-title="<?=$this->lang->line('studentfinereport_date');?>">
                                                <?=date('d M Y',strtotime((string) $studentfine->paymentdate))?>
                                            </td>
