...
<h3 style="margin-bottom: 0px;"><?=$this->lang->line('productsalereport_report_for')?> - <?=$this->lang->line('productsalereport_productsale')?> </h3>
    <?php if($fromdate != '' && $todate != '' ) { ?>
        <div>
            <h5 class="pull-left">
                <?=$this->lang->line('productsalereport_fromdate')?> : <?=date('d M Y',strtotime((string) $fromdate))?></p>
            </h5>
            <h5 class="pull-right">
                <?=$this->lang->line('productsalereport_todate')?> : <?=date('d M Y',strtotime((string) $todate))?></p>
            </h5>
        </div>
    ...
    <div style="margin-top:0px">
        <?php if (customCompute($productsales)) { ?>
