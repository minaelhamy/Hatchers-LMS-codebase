    ...
    <div style="margin-bottom: 50px;">
        <div class="row">
            ...
            <div class="accountledgerreport">
                <?php if(customCompute($onlineadmissions)) { ?>
                <table> 
                    <thead>
                        <tr>
                        ...
                        <?php $i = 0; foreach($onlineadmissions as $onlineadmission) { $i++; ?>
                            <tr>
                                ...
                                <?php if($admissionID == 0) { ?>
                                    <td>
                                        <?php 
                                            $admissionIDlen = strlen((string) $onlineadmission->onlineadmissionID);
                                            $boxLimit = 8;
                                            ...
                                            $admissionIDArray = str_split((string) $onlineadmission->onlineadmissionID);
