<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            if($fromdate != '' && $todate != '' )  {
                $pdf_preview_uri = base_url('accountledgerreport/pdf/'.$schoolyearID.'/'.strtotime((string) $fromdate).'/'.strtotime((string) $todate));
            } else {
        ...
        <div class="box-body" style="margin-bottom: 50px;">
            <div class="row">
                ...
                <?php $m = true; if($fromdate != '' && $todate != '') { $m = false; ?>
                    <div class="col-sm-12">
                        <h5 class="pull-left"><?=$this->lang->line('accountledgerreport_fromdate')?> : <?=date('d M Y',strtotime((string) $fromdate))?></h5>                         
                        <h5 class="pull-right"><?=$this->lang->line('accountledgerreport_todate')?> : <?=date('d M Y',strtotime((string) $todate))?></h5>
                    </div>
                <?php } ?>
                        ...
                        <div class="singleaccountledger">
                            <table class="table table-bordered marginledgerreport">
                                ...
                                <tr>
                                    ...
                                    <td><?= $totalincome !== null ? number_format($totalincome, 2) : '0.00' ?></td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-bordered marginledgerreport">
                                ...
                                <tr>
                                    ...
                                    <td><?= $totalcollection !== null ? number_format($totalcollection, 2) : '0.00' ?></td>

                                </tr>
                                <tr>
                                    <td><?=$this->lang->line('accountledgerreport_fines')?> (+)</td>
                                    <td><?= $totalfine !== null ? number_format($totalfine, 2) : '0.00' ?></td>

                                </tr>
                                <tr>
                                    <td><?=$this->lang->line('accountledgerreport_expense')?> (-)</td>
                                    <td><?= $totalexpense !== null ? number_format($totalexpense, 2) : '0.00' ?></td>
                                </tr>
                                <tr>
                                    <td><?=$this->lang->line('accountledgerreport_salary')?> (-)</td>
                                    <td><?= $totalsalarypayment !== null ? number_format($totalsalarypayment, 2) : '0.00' ?></td>
