    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <?php if(customCompute($onlineexam_user_statuss)) { ?>
	                    <div id="hide-table">
                                    ...
                                    <tr>
	                                    ...
	                                    <?php if($studentID > 0) { ?>
		                                    <td data-title="<?=$this->lang->line('onlineexamreport_subject')?>">
		                                    	<?=isset($subjects[$onlineexam_user_status->subjectID]) ? $subjects[$onlineexam_user_status->subjectID]->subject : '&nbsp;'?>
		                                    </td>
	                                    <?php } ?>

	                                    <td data-title="<?=$this->lang->line('onlineexamreport_datetime')?>">
	                                    	<?=date('d M Y - h:i:s A', strtotime((string) $onlineexam_user_status->time))?>
	                                    </td>
