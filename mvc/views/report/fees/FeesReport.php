<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            if($fromdate != '' && $todate != '') {
                $pdf_preview_uri = base_url('feesreport/pdf/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$feetypeID.'/'.strtotime((string) $fromdate).'/'.strtotime((string) $todate));
            } else {
                $pdf_preview_uri = base_url('feesreport/pdf/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$feetypeID);
            }

            if($fromdate != '' && $todate != '') {
                $xml_preview_uri = base_url('feesreport/xlsx/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$feetypeID.'/'.strtotime((string) $fromdate).'/'.strtotime((string) $todate));
            } else {
                                ...
                                <?php
                                    ...
                                    foreach($getFeesReports as $getFeesReport) { 
                                        ...
                                        <tr>
                                            ...
                                            <td data-title="<?=$this->lang->line('feesreport_payment_date')?>"><?=date('d M Y',strtotime((string) $getFeesReport->paymentdate))?></td>
