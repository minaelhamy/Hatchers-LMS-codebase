<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $birthdaydatetime = ($birthdaydate != '') ? strtotime((string) $birthdaydate) : '0';
...
<div class="box">
    <div class="box-header bg-gray">
        <h3 class="box-title text-navy"><i class="fa fa-clipboard"></i> <?=$this->lang->line('studentreport_report_for')?> - <?=ucwords((string) $reportfor)?> ( <?=$reportTitle?> ) </h3>
    </div><!-- /.box-header -->
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php } if($sectionID == 0 || $sectionID == '') { ?>
                                            <td data-title="<?=$this->lang->line('studentreport_section')?>">
