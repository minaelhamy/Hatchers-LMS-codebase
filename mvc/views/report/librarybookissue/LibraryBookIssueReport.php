    ...
    <!-- form start -->
        <div class="box-body" style="margin-bottom: 50px;">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <?php if(customCompute($getLibrarybookissueReports)) { ?>
                    <div id="hide-table">
                                            ...
                                            <?php 
                                                if($typeID == 0) {
                                                    if(isset($getLibrarybookissueReport->issue_date)) {
                                                        echo '<td data-title="'.$this->lang->line('librarybookissuereport_issuedate').'">'.date('d M Y', strtotime((string) $getLibrarybookissueReport->issue_date)).'</td>';
                                                    } else {
                                                        echo '<td data-title="'.$this->lang->line('librarybookissuereport_issuedate').'">&nbsp;</td>';
                                                    }

                                                    if(isset($getLibrarybookissueReport->due_date)) {
                                                        echo '<td data-title="'.$this->lang->line('librarybookissuereport_duedate').'">'.date('d M Y', strtotime((string) $getLibrarybookissueReport->due_date)).'</td>';
                                                    } else {
                                                        echo '<td data-title="'.$this->lang->line('librarybookissuereport_duedate').'">&nbsp;</td>';
                                                    }

                                                    if(isset($getLibrarybookissueReport->return_date)) {
                                                        echo '<td data-title="'.$this->lang->line('librarybookissuereport_returndate').'">'.date('d M Y', strtotime((string) $getLibrarybookissueReport->return_date)).'</td>';
                                                    } else {
...
<?php 
    $fromdate = $fromdate != 0 ? date('d-m-Y',$fromdate) : '';

    $todate = $todate != 0 ? date('d-m-Y',$todate) : '';
?>
