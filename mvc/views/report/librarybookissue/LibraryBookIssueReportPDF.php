                    ...
                    <tr>
                        ...
                        if($typeID == 0) {
                            if(isset($getLibrarybookissueReport->issue_date)) {
                                echo '<td>'.date('d M Y', strtotime((string) $getLibrarybookissueReport->issue_date)).'</td>';
                            } else {
                                echo '<td data-title="'.$this->lang->line('librarybookissuereport_issuedate').'"></td>';
                            }

                            if(isset($getLibrarybookissueReport->due_date)) {
                                echo '<td>'.date('d M Y', strtotime((string) $getLibrarybookissueReport->due_date)).'</td>';
                            } else {
                                echo '<td></td>';
                            }

                            if(isset($getLibrarybookissueReport->return_date)) {
                                echo '<td>'.date('d M Y', strtotime((string) $getLibrarybookissueReport->return_date)).'</td>';
                            } else {
                                echo '<td></td>';
                            }
                        } elseif($typeID == 1) {
