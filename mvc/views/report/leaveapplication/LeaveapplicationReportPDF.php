        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <?php $i = 0; foreach($leaveapplications as $leaveapplication) { $i++; ?>
                <tr>
                    ...
                    <td data-title="<?=$this->lang->line('leaveapplicationreport_date')?>"><?=date('d M Y',strtotime((string) $leaveapplication->apply_date))?></td>
                    <td data-title="<?=$this->lang->line('leaveapplicationreport_schdule')?>"><?=date('d M Y',strtotime((string) $leaveapplication->from_date))?> - <?=date('d M Y',strtotime((string) $leaveapplication->to_date))?></td>
