...
<body>
    ...
    <div><h3> <?=$this->lang->line('routinereport_report_for')?> - <?=$this->lang->line('routinereport_routine')?> ( <?=ucwords((string) $routinefor)?> ) </h3></div>
    <div>
    <?php if(($routinefor == 'student') && customCompute($classes) && isset($sections[$get_section])) { ?>
