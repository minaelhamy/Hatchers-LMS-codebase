        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="box-header bg-gray">
                    <h3 class="box-title text-navy"><i class="fa fa-clipboard"></i> <?=$this->lang->line('attendancereport_report_for')?> <?=$this->lang->line('attendancereport_attendance')?> - <?=$attendancetype?> ( <?=date('d M Y',strtotime((string) $date))?> ) </h3>
                </div><!-- /.box-header -->
                <div class="col-sm-12">
