                        ...
                        <table id="example1" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    <tr>
                                        <td><?=$i?></td>
                                        <td><?=date('d M Y',strtotime((string) $get_payment->paymentdate))?></td>
                                ...
                                if(customCompute($incomes)) {
                                    ...
                                    foreach($incomes as $income) { ?>
                                        <tr>
                                            <td><?=$i?></td>
                                            <td><?=$income->name?></td>
                                            <td><?=date('d M Y',strtotime((string) $income->date))?></td>
                                            <td>
                                                <?php 
                            ...
                            <tbody>
                                <?php $totalexpense = 0; $i=1; if(customCompute($expenses)) { foreach($expenses as $expense) {?>
                                    <tr>
                                        ...
                                        <td><?=date('d M Y',strtotime((string) $expense->date))?></td>
                                        <td>
                                        <?php
                 ...
                 <table>
                    ...
                    <tbody>
                        <?php $totalSalary = 0; $i=1; if(customCompute($salarys)) { foreach($salarys as $salary) {?>
                            <tr>
                                <td><?=$i?></td>
                                <td><?=date('d M Y',strtotime((string) $salary->create_date))?></td>
