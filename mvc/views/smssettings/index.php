<div class="box">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="<?php if ($clickatell == 1) {
    echo 'active';
} ?>"><a data-toggle="tab" href="#clickatell" aria-expanded="true">Clickatell</a></li>
                            <li class="<?php if ($twilio == 1) {
    echo 'active';
} ?>"><a data-toggle="tab" href="#twilio" aria-expanded="true">Twilio</a></li>
                            <li class="<?php if ($bulk == 1) {
    echo 'active';
} ?>"><a data-toggle="tab" href="#bulk" aria-expanded="true">Bulk</a></li>
                            <li class="<?php if ($msg91 == 1) {
    echo 'active';
} ?>"><a data-toggle="tab" href="#msg91" aria-expanded="true">MSG91</a></li>
                        </ul>

                        <div class="tab-content">
                            <div id="clickatell" class="tab-pane <?php if ($clickatell == 1) {
    echo 'active';
}?> ">
                                <br>
                                <div class="row">
    ...
    echo "<div class='form-group' >";
                            ...
                            <div id="twilio" class="tab-pane <?php if ($twilio == 1) {
                                                echo 'active';
                                            } ?>">
                                <br>
                                <div class="row">
                            ...
                            <div id="bulk" class="tab-pane <?php if ($bulk == 1) {
                                                echo 'active';
                                            }?> ">
                                <br>
                                <div class="row">
                            ...
                            <div id="msg91" class="tab-pane <?php if ($msg91 == 1) {
                                                echo 'active';
                                            }?> ">
                                <br>
                                <div class="row">
