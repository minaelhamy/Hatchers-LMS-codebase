<div class="box">
    ...
    echo "<div class='form-group' >";
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="fdate" name="fdate" value="<?=set_value('fdate',date("d-m-Y", strtotime((string) $holiday->fdate)))?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="tdate" name="tdate" value="<?=set_value('tdate',date("d-m-Y", strtotime((string) $holiday->tdate)))?>" >
                        </div>
                        <span class="col-sm-4 control-label">
