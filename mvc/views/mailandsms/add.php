            ...
            <div class="col-sm-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="<?php if ($email == 1) {
    echo 'active';
} ?>"><a data-toggle="tab" href="#email" aria-expanded="true"><?=$this->lang->line('mailandsms_email')?></a></li>
                        <li class="<?php if ($sms == 1) {
    echo 'active';
} ?>"><a data-toggle="tab" href="#sms" aria-expanded="true"><?=$this->lang->line('mailandsms_sms')?></a></li>
                        <li class="<?php if ($otheremail == 1) {
    echo 'active';
} ?>"><a data-toggle="tab" href="#otheremail" aria-expanded="true"><?=$this->lang->line('mailandsms_otheremail')?></a></li>
                        <li class="<?php if ($othersms == 1) {
    echo 'active';
} ?>"><a data-toggle="tab" href="#othersms" aria-expanded="true"><?=$this->lang->line('mailandsms_othersms')?></a></li>
                    </ul>

                    <div class="tab-content">
                        <div id="email" class="tab-pane <?php if ($email == 1) {
    echo 'active';
}?> ">
                            <br>
                            <div class="row">
                                <div class="col-sm-10">
                                    ...
                                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php 
                                            if (form_error('otheremail_attachment')) {
                                                echo "<div class='form-group has-error'>";
                                            } else {
                                                echo "<div class='form-group'>";
                                            }
                                        ?>
                                            <label for="otheremail_attachment" class="col-sm-2 control-label">
                                                <?=$this->lang->line("mailandsms_attachment")?>
                                            </label>
                                            <div class="col-sm-6">
                                            ...
                                            <?= $this->lang->line('mailandsms_clear') ?>
                                        </button>
                                                                <div class="btn btn-success image-preview-input">
                                                                    <span class="fa fa-repeat"></span>
                                                                    <span class="image-preview-input-title">
                                                                        <?= $this->lang->line('mailandsms_file_browse') ?></span>
                        ...
                        <div id="sms" class="tab-pane <?php if ($sms == 1) {
                                            echo 'active';
                                        } ?>">
                            <br>
                            <div class="row">
                        ...
                        <div id="otheremail" class="tab-pane <?php if ($otheremail == 1) {
                                            echo 'active';
                                        }?> ">
                            <br>
                            <div class="row">
                                <div class="col-sm-10">
                                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                        ...
                                        ?>
                                            ...
                                            <span class="col-sm-4 control-label">
                                                <?php echo form_error('otheremail_attachment'); ?>
                                            </span>
                        ...
                        <div id="othersms" class="tab-pane <?php if ($othersms == 1) {
                                            echo 'active';
                                        }?> ">
                            <br>
                            <div class="row">
