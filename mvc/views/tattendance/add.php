                ...
                <?php if(customCompute($teachers)) { ?>
                    <div id="hide-table">
                        <table class="table table-striped table-bordered table-hover dataTable no-footer">
                            ...
                            <tbody id="list">
                                <?php if(customCompute($teachers)) {$i = 1; foreach($teachers as $teacher) { if(isset($tattendances[$teacher->teacherID])) { ?>
                                    <tr>
                                        ...
                                        <td data-title="<?=$this->lang->line('tattendance_attendance')?>">
                                            <?php
                                                $aday = "a".abs($day);
                                                if (isset($tattendances[$teacher->teacherID]) && ($monthyear == $tattendances[$teacher->teacherID]->monthyear && $tattendances[$teacher->teacherID]->teacherID == $teacher->teacherID)) {
                                                    $pmethod = '';
                                                    $lemethod = '';
                                                    $lmethod = '';
                                                    $amethod = '';
