<form method="POST">
    <div class="row">
        <div class="col-md-8">
            <div class="add--page--wrap">
                <h3><?=$this->lang->line('pages_edit_page')?></h3>

                <div class="form-group <?=form_error('title') ? 'has-error' : '' ?>">
                    <input type="text" id="title" value="<?=set_value('title', $page->title)?>" name="title" class="form-control" placeholder="<?=$this->lang->line('pages_enter_title_here')?>">
                ...
                <div class="bg-white mb-15">
                    ...
                    <div class="sidebar-body" id="publish-box">
                        <div class="save-preview-btn clearfix">
                            <button type="submit" id="preview" class="save-preview-btn pull-right clearfix" value="preview" name="submit"><?=$this->lang->line('pages_preview_changes')?></button>
    ...
    echo $this->lang->line('pages_published');
}
                                ?>
                            ...
                            <div class="post-status-select" id="draft-edit-show">
                                <?php 
                                    $statusArray = array(
                                        'published' => $this->lang->line('pages_published'),
                        ...
                        <div class="post-status">
                            ...
                            <div class="post-status-select" id="publish-edit-show">
                                <?php
                                    ...
                                    echo form_dropdown("publish_month", $monthArray, set_value("publish_month", date("m", strtotime((string) $page->publish_date))), "id='publish_month' class='".$addClass."'"); 
                                ?>
                                <label class="sr-only">Day</label>
                                <input id="publish_day" name="publish_day" type="text" value="<?=set_value('publish_day', date("d", strtotime((string) $page->publish_date)))?>" size="2" class="<?=$addClass?>" maxlength="2">
                                <label class="sr-only">year</label>
                                <input id="publish_year" name="publish_year" type="text" value="<?=set_value('publish_year', date("Y", strtotime((string) $page->publish_date)))?>" size="4" class="<?=$addClass?>" maxlength="4">
                                <span>@</span>
                                <input id="publish_hour" name="publish_hour" type="text" value="<?=set_value('publish_hour', date("H", strtotime((string) $page->publish_date)))?>" size="2" class="<?=$addClass?>" maxlength="2">
                                <span>:</span>
                                <input id="publish_minute" name="publish_minute" type="text" value="<?=set_value('publish_minute', date("i", strtotime((string) $page->publish_date)))?>" size="2" class="<?=$addClass?>" maxlength="2">
                    ...
                    <div id="publish-box-footer" class="publish-btn text-right">
                        <input type="submit" name="submit" value="<?=$this->lang->line('pages_update')?>">
                    </div>
                </div>
...
<div id="visiblity" style="display: <?php
                                            if ($page->template !== "about" && $page->template !== "home") {
                                                        echo "none;";
                                                    }
                                    ?>">
                <div class="bg-white mb-15">
                ...
                <div class="bg-white mb-15" id="visiblitya" style="display:<?php
        ...
        $('.save-post-status').click(function(e) {
            ...
            if(id == 'save-status') {
                ...
                if(saveStatusValue == 'draft') {
                    ...
                    saveStatusValue = "<?=$this->lang->line('pages_published')?>";
