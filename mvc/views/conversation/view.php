                    ...
                    <div class="box-body chat" id="chat-box">
                      ...
                      <?php foreach ($messages as $message): ?>
                          <div class="item">
                            ...
                            <p class="message">
                              <a href="#" class="name">
                                <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> <?=date('d M Y h:i:s A', strtotime((string) $message->create_date))?></small>
                            ...
                            <div class="attachment">
                              ...
                              <div class="pull-right">
                                <a href="<?php echo base_url("conversation/open/".$message->conversation_id.'/'.$message->msg_id); ?>" class="btn btn-primary btn-sm btn-flat"><?=$this->lang->line('open')?></a>
                              </div>
                            </div><!-- /.attachment -->              
                            <?php endif ?>
                          </div><!-- /.item -->
