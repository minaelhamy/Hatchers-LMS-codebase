                                ...
                                <?php if ($conversations): ?>
                                    <?php if(customCompute($conversations)) {$i = 1; foreach($conversations as $conversation) { ?>
                                        <tr class="">
                                            ...
                                            <td data-title="<?=$this->lang->line('reply')?>" class="mailbox-reply"><span class="label label-info"><?=($conversation->msgCount == 1) ? 0 : $conversation->msgCount?></span></td>
                                        </tr>
                                    <?php $i++; }} ?>
                                <?php endif ?>
                                </tbody>
...
<?php if(isset($methodpass)) { if($methodpass == 'trash') { ?>
    <script>
