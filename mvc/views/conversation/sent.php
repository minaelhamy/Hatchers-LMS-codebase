                ...
                <div class="box-body">
                    ...
                    <div id="hide-table">
                        <table id="withoutBtn" class="table table-hover dataTable no-footer">
                            ...
                            <tbody>
                            <?php if(customCompute($messages)) {$i = 1; foreach($messages as $message) { ?>
                                <tr class="<?=$message->reply_status==1 ? "unread" : "read"?>">
                                  ...
                                  <td data-title="<?=$this->lang->line('subject')?>" class="mailbox-subject"><b><?=substr((string) $message->subject, 0,10).".."?></b> </td>
                                  <td data-title="<?=$this->lang->line('attach')?>" class="mailbox-attachment"><?php if ($message->attach != '') {?><i class="fa fa-paperclip"></i><?php } ?></td>
                                  <?php $newDateTime = date('d M Y h:i:s A', strtotime((string) $message->create_date));?>
