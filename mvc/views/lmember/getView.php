    ...
    <div class="well">
        <div class="row">
            <div class="col-sm-7">
                ...
                <?php
                    if(customCompute($lmember) && (($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) && permissionChecker('lmember_edit')) {
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('lmember_classes')?></b> <a class="pull-right"><?=customCompute($classes) ? $classes->classes : ''?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                            ...
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    <div class="profile-view-tab">
                                        ...
                                        <?php if($student->dob) { echo date("d M Y", strtotime((string) $student->dob)); } else { echo ''; }?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_lID")?> </span>: <?=customCompute($lmember) ? $lmember->lID : 'N/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_lfee")?> </span>: <?=customCompute($lmember) ? $lmember->lbalance : 'N/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_joindate")?> </span>: <?=customCompute($lmember) ? date("d M Y", strtotime((string) $lmember->ljoindate)) : 'N/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
