                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("hostelID", $array, set_value("hostelID", $hmember->hostelID), "id='hostelID' class='form-control select2'");
                            ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("categoryID", $array, set_value("categoryID", $hmember->categoryID), "id='categoryID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
