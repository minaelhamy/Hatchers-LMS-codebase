                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="70%"><?=customCompute($hostel) ? $hostel->name : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_htype")?></th>
                            <td width="70%"><?=customCompute($hostel) ? $hostel->htype : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_class_type")?></th>
                            <td width="70%"><?=customCompute($category) ? $category->class_type : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_tfee")?></th>
                            <td width="70%"><?=customCompute($hmember) ? $hmember->hbalance : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_hostel_address")?></th>
                            <td width="70%"><?=customCompute($hostel) ? $hostel->address : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_joindate")?></th>
                            <td width="70%"><?php if(customCompute($hmember)) { if($hmember->hjoindate) { echo date("d M Y", strtotime((string) $hmember->hjoindate)); } } else { echo 'N/A'; }  ?></td>
                        </tr>
                        <tr>
