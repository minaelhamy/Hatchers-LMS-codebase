    ...
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                ...
                <?php
                    if(customCompute($hmember) && (($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) && permissionChecker('hmember_edit')) {
                            ...
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_dob")?> </span>: <?php if($student->dob) { echo date("d M Y", strtotime((string) $student->dob)); }?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_joindate")?> </span>: <?php if(customCompute($hmember)) { if($hmember->hjoindate) { echo date("d M Y", strtotime((string) $hmember->hjoindate)); } } else { echo 'N/A'; } ?></p>
                                    </div>
                                    <div class="profile-view-tab">
