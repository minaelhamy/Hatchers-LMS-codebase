            ...
            <div class="col-sm-12">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <?php } ?>                                                                                                                                               
                        <?php if (customCompute($folders)): ?>
                            <?php foreach ($folders as $folder): ?>
                                <div class="col-lg-3 col-sm-12">
                                    <a href="<?=base_url("media/view/$folder->mcategoryID")?>" class="btn btn-app bg-navy" id="media-folder">
                                    <?php  
                                    if(strlen((string) $folder->folder_name) > 12) {
                                       echo substr((string) $folder->folder_name, 0,12). ".."; 
                                    } else {
                                    ...
                                    <?php endif ?>
                                    <b class="media-file-propractice-for-media"><?=$this->lang->line('media_uploadedby')?> <?=$allusertype[$folder->usertypeID];?>: <?=$folder->shared_by;?></b>                                                                                                                   
                                </div>
                            <?php endforeach ?>
                        <?php endif ?>

                        <?php if (customCompute($files)): ?>
                            <?php foreach ($files as $file): ?>
                                <div class="col-lg-3 col-sm-12">                                
                                    ...
                                    <?php 
                                    if(strlen((string) $file->file_name_display) > 15) {
                                       echo substr((string) $file->file_name_display, 0,15). ".."; 
                                    } else {
