<div class="box">
    ...
    echo "<div class='form-group' >";
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="name" name="name" value="<?=set_value('name', $permissionlog->name)?>" >
                    </div>
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="description" name="description" value="<?=set_value('description', $permissionlog->description)?>" >
            </div>
            <span class="col-sm-4 control-label">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="active" name="active" value="<?=set_value('active', $permissionlog->active)?>" >
        </div>
        <span class="col-sm-4 control-label">
