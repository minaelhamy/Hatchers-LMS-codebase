                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach ($permissions as $data) {
                                            if(strpos((string) $data->name, '_edit') == false && strpos((string) $data->name, '_view') == false && strpos((string) $data->name, '_delete') == false && strpos((string) $data->name, '_add') == false) {
                                                $push['name'] = $data->name;
                                            ...
                                            <td data-title="<?=$this->lang->line('slno')?>">
                                                <?php
                                                    ...
                                                    if(isset($permissionCheckBox[$data['name']])) {
                                                        ...
                                                        } elseif ($permissionCheckBoxVal[$data['name']]) {
                                                            $status = "disabled";
                                            ...
                                            <td data-title="<?=$this->lang->line('permission_add')?>">
                                                <?php
                                                    if(isset($permissionCheckBox[$data['name'].'_add'])) {
                                                        ...
                                                        } elseif ($permissionCheckBoxVal[$data['name'].'_add']) {
                                            ...
                                            <td data-title="<?=$this->lang->line('permission_edit')?>">
                                                <?php
                                                    if(isset($permissionCheckBox[$data['name'].'_edit'])) {
                                                        ...
                                                        } elseif ($permissionCheckBoxVal[$data['name'].'_edit']) {
                                            ...
                                            <td data-title="<?=$this->lang->line('permission_delete')?>">
                                                <?php
                                                    if(isset($permissionCheckBox[$data['name'].'_delete'])) {
                                                        ...
                                                        } elseif ($permissionCheckBoxVal[$data['name'].'_delete']) {
                                            ...
                                            <td data-title="<?=$this->lang->line('permission_view')?>">
                                                <?php
                                                    if(isset($permissionCheckBox[$data['name'].'_view'])) {
                                                        ...
                                                        } elseif ($permissionCheckBoxVal[$data['name'].'_view']) {
