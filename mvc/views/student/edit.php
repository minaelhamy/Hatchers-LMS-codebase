            ...
            <div class="col-sm-10">
                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php $admission_date = ''; if($student->admission_date) { $admission_date = date("d-m-Y", strtotime((string) $student->admission_date)); }  ?>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php $dob = ''; if($student->dob) { $dob = date("d-m-Y", strtotime((string) $student->dob)); }  ?>
