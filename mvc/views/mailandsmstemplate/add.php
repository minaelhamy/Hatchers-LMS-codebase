<div class="box">
    ...
    echo 'active';
} ?>"><a data-toggle="tab" href="#email" aria-expanded="true"><?=$this->lang->line('mailandsmstemplate_email')?></a></li>
                        <li class="<?php if ($sms == 1) {
    echo 'active';
} ?>"><a data-toggle="tab" href="#sms" aria-expanded="true"><?=$this->lang->line('mailandsmstemplate_sms')?></a></li>
                    </ul>
                                            ...
                                            if(customCompute($usertypes)) {
                                                foreach ($usertypes as $key => $usertype) {
                                                    if($usertype->usertypeID == 2) {
                                                        ...
                                                        echo '<div class="emailtagdiv" id="email_'.str_replace(' ', '', (string) $usertype->usertype).'">';
                                                            echo $users;
                                                        echo '</div>';
                                                ...
                                                if(customCompute($usertypes)) {
                                                    foreach ($usertypes as $key => $usertype) {
                                                        if($usertype->usertypeID == 2) {
                                                            ...
                                                            echo '<div class="smstagdiv" id="sms_'.str_replace(' ', '', (string) $usertype->usertype).'">';
                                                                echo $users;
                                                            echo '</div>';
                ...
                if(customCompute($usertypes)) {
                    foreach ($usertypes as $key => $usertype) {
                        echo 'if('.$usertype->usertypeID." == email_setuser) {"."\n";
                            echo '$("#email_'.str_replace(' ', '', (string) $usertype->usertype).'").show();'."\n";
                        echo '} else {'."\n";
                            echo '$("#email_'.str_replace(' ', '', (string) $usertype->usertype).'").hide();'."\n";
                        echo '}'."\n";
                    }
                }
            ?>
                ...
                if(customCompute($usertypes)) {
                    foreach ($usertypes as $key => $usertype) {
                        echo 'if('.$usertype->usertypeID." == sms_setuser) {"."\n";
                            echo '$("#sms_'.str_replace(' ', '', (string) $usertype->usertype).'").show();'."\n";
                        echo '} else {'."\n";
                            echo '$("#sms_'.str_replace(' ', '', (string) $usertype->usertype).'").hide();'."\n";
                        echo '}'."\n";
                    }
                }
