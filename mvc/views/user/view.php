<div class="well">
    <div class="row">
        <div class="col-sm-6">
            ...
            <?php if(permissionChecker('user_edit')) { echo btn_sm_edit('user/edit/'.$user->userID."/", $this->lang->line('edit')); } 
            ?>
        ...
        <div class="panel-body profile-view-dis">
            ...
            <div class="row">
                <div class="profile-view-tab">
                    <p><span><?=$this->lang->line("user_dob")?> </span>: <?=date("d M Y", strtotime((string) $user->dob));?></p>
                </div>
                <div class="profile-view-tab">
                    <p><span><?=$this->lang->line("user_jod")?> </span>: <?=date("d M Y", strtotime((string) $user->jod))?></p>
                </div>
                <div class="profile-view-tab">
