            ...
            <div class="areaTop">
                ...
                <div class="studentProfile">
                    ...
                    <div class="singleItem">
                        ...
                        <div class="single_value">: <?php if($systemadmin->dob) { echo date("d M Y", strtotime((string) $systemadmin->dob)); } ?></div>
                    </div>
                    <div class="singleItem">
            ...
            <div class="areaBottom">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td width="70%"><?php if($systemadmin->jod) { echo date("d M Y", strtotime((string) $systemadmin->jod)); } ?></td>
                    </tr>
                    <tr>
