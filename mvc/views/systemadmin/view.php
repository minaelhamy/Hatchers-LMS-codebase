        ...
        <div class="panel-body profile-view-dis">
            ...
            <div class="row">
                <div class="profile-view-tab">
                    <p><span><?=$this->lang->line("systemadmin_dob")?> </span>: <?=date("d M Y", strtotime((string) $systemadmin->dob));?></p>
                </div>
                <div class="profile-view-tab">
                    <p><span><?=$this->lang->line("systemadmin_jod")?> </span>: <?=date("d M Y", strtotime((string) $systemadmin->jod))?></p>
                </div>
                <div class="profile-view-tab">
