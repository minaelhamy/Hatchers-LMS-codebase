                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('systemadmin_dob')?></b> <a class="pull-right"><?=date('d M Y',strtotime((string) $profile->dob))?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("systemadmin_jod")?> </span>: <?=date('d M Y',strtotime((string) $profile->jod))?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                                    ...
                                                    <td data-title="<?php if($manage_salary->salary == 2) { echo $this->lang->line('systemadmin_net_salary_hourly'); } else { echo $this->lang->line('systemadmin_net_salary'); } ?>">
                                                        <?php
                                                            if(isset($make_payment->total_hours)) {
                                                                echo '('.$make_payment->total_hours. 'X' . $make_payment->net_salary .') = '. (($make_payment->total_hours * $make_payment->net_salary) !== null ? number_format(($make_payment->total_hours * $make_payment->net_salary), 2) : '0.00'  ); 
                                                            } else {
                                                                echo $make_payment->net_salary !== null ? number_format($make_payment->net_salary, 2) : '0.00'; 
                                                            }
                                                        ?>
                                                    </td>

                                                    <td data-title="<?=$this->lang->line('systemadmin_payment_amount')?>">
                                                        <?php echo  $make_payment->payment_amount !== null ? number_format($make_payment->payment_amount, 2) : '0.00'; $paymentTotal += $make_payment->payment_amount; ?>
                                                    </td>
                                                </tr>
                                            <?php $i++; }} ?>
                                            <tr>
                                                ...
                                                <td data-title="<?=$this->lang->line('systemadmin_total')?> <?=$this->lang->line('systemadmin_payment_amount')?>">
                                                    <?=  $paymentTotal !== null ? number_format($paymentTotal, 2) : '0.00' ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
