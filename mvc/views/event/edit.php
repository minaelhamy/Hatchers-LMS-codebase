<div class="box">
    ...
    <?php
      $date = date("m/d/Y", strtotime((string) $event->fdate))." ".date("h:i A", strtotime((string) $event->ftime))." - ".date("m/d/Y", strtotime((string) $event->tdate))." ".date("h:i A", strtotime((string) $event->ttime));
    ?>
    <!-- form start -->
    <div class="box-body">
        <div class="row">
