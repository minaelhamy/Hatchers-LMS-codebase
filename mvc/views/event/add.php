<div class="box">
    ...
    echo "<div class='form-group' >";
                    ...
                    <input type="hidden" id="startingDate" value="<?= date('m/d/Y', strtotime($schoolyearsessionobj->startingdate)) ?>">
                    <input type="hidden" id="endingDate" value="<?= date('m/d/Y', strtotime($schoolyearsessionobj->endingdate)) ?>">
...
$('#date').data('daterangepicker').setStartDate($('#startingDate').val());
$('#date').data('daterangepicker').setEndDate($('#endingDate').val());
