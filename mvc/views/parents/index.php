            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tbody>
                            <?php if(customCompute($parents)) {$i = 1; foreach($parents as $parent) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('parents_status')?>">
                                      <div class="onoffswitch-small" id="<?=$parent->parentsID?>">
                                          <input type="checkbox" id="myonoffswitch<?=$parent->parentsID?>" class="onoffswitch-small-checkbox" name="parents_status" <?php if ($parent->active === '1') {
