                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        <label for="name" class="col-sm-2 control-label">
                            <?=$this->lang->line("hostel_name")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="htype" class="col-sm-2 control-label">
                            <?=$this->lang->line("hostel_htype")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                $array = array(
                                ...
                                echo form_dropdown("htype", $array, set_value("htype", $hostel->htype), "id='htype' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        <label for="address" class="col-sm-2 control-label">
                            <?=$this->lang->line("hostel_address")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
