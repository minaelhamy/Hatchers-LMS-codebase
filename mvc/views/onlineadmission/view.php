<?php if(customCompute($admissioninfo)) { ?>
    <div class="well">
        <div class="row">
            <div class="col-sm-8">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item" style="background-color: #FFF">
                                ...
                                <a class="pull-right">
                                    <?php
                                        $admissionIDlen = strlen((string) $admissioninfo->onlineadmissionID);
                                        $boxLimit = 8;
                                        ...
                                        $admissionIDArray = str_split((string) $admissioninfo->onlineadmissionID);
                            ...
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('onlineadmission_apply_classes')?></b> <a class="pull-right"><?=customCompute($classes) ? $classes->classes : ''?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                            ...
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    <div class="profile-view-tab">
                                        ...
                                        <?php if($admissioninfo->dob) { echo date("d M Y", strtotime((string) $admissioninfo->dob)); } ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                    ...
                                    <div class="profile-view-tab">
                                        <p>
                                            <span><?=$this->lang->line("onlineadmission_document")?> </span>: 
                                            <?php
                                                if($admissioninfo->document){
                                                    echo btn_download('onlineadmission/download_documentd/'.$admissioninfo->onlineadmissionID.'/'.$admissioninfo->classesID, $this->lang->line('onlineadmission_document'));
                                                }
                                            ?>
                                        </p>
                                    </div>
