<div class="box">
    ...
    echo "<div class='form-group' >";
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="title" name="title" value="<?=set_value('title')?>" placeholder="<?=$this->lang->line("exam_type_title")?>">
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="typeNumber" name="typeNumber" value="<?=set_value('typeNumber')?>" placeholder="<?=$this->lang->line("exam_type_typeNumber")?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="status" name="status" value="<?=set_value('status')?>" placeholder="<?=$this->lang->line("exam_type_status")?>">
                        </div>
                        <span class="col-sm-4 control-label">
