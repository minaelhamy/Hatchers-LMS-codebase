...
<!--                                --><?php //} ?>
                        ...
                        <tbody>
                            <?php if(customCompute($exam_types)) {$i = 1; foreach($exam_types as $exam_type) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('exam_type_title')?>">
                                        <?php
                                            if (strlen((string) $exam_type->title) > 25) {
                    echo strip_tags(substr((string) $exam_type->title, 0, 25)."...");
                } else {
                    echo strip_tags(substr((string) $exam_type->title, 0, 25));
                }
                                        ?>
