...
<div class="col-sm-6">
    <input type="text" class="form-control" id="startdate" name="startdate" value="<?= set_value('startdate', is_null($online_exam->startDateTime) ? '' : date('d-m-Y', strtotime((string) $online_exam->startDateTime))) ?>">
</div>
<span class="col-sm-4 control-label">
...
<div class="col-sm-6">
    <input type="text" class="form-control" id="enddate" name="enddate" value="<?= set_value('enddate', is_null($online_exam->endDateTime) ? '' : date('d-m-Y', strtotime((string) $online_exam->endDateTime))) ?>">
</div>
<span class="col-sm-4 control-label">
...
<div class="col-sm-6">
    <input type="text" class="form-control" id="startdatetime" name="startdatetime" value="<?= set_value('startdatetime', is_null($online_exam->startDateTime) ? '' : date('d-m-Y h:i a', strtotime((string) $online_exam->startDateTime))) ?>">
</div>
<span class="col-sm-4 control-label">
...
<div class="col-sm-6">
    <input type="text" class="form-control" id="enddatetime" name="enddatetime" value="<?= set_value('enddatetime', is_null($online_exam->endDateTime) ? '' : date('d-m-Y h:i a', strtotime((string) $online_exam->endDateTime))) ?>">
</div>
<span class="col-sm-4 control-label">
...
<div class="col-sm-6">
    ...
    echo form_dropdown("random", $randomArray, set_value("random", $online_exam->random), "id='random' class='form-control select2'");
    ?>
</div>
<span class="col-sm-4 control-label">
