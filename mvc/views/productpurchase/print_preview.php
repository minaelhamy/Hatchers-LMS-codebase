  ...
  <div>
    ...
    <table class="table table-bordered">
      ...
      <tfoot>
          ...
          <tr>
              <td class="pull-right" colspan="4"><b><?=$this->lang->line('productpurchase_balance');?> 
              <?=empty($siteinfos->currency_code) ? '' : '('.$siteinfos->currency_code.')'?></b></td>
        ...
        <tr>
            ...
            <td width="35%">
                <table>
                    ...
                    <tr>
                        <td><?=$this->lang->line('productpurchase_date')?> : <?=date('d M Y', strtotime((string) $productpurchase->create_date))?></td>
                    </tr>
                </table>
            </td>
        </tr>
