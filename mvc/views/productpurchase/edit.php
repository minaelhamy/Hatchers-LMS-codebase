                ...
                <form role="form" method="post" enctype="multipart/form-data" id="productPurchaseDataForm"> 
                    ...
                    <div class="productpurchasedateDiv form-group <?=form_error('productpurchasedate') ? 'has-error' : '' ?>" >
                        <label for="productpurchasedate">
                            ...
                            <input type="text" class="form-control" id="productpurchasedate" name="productpurchasedate" value="<?=set_value('productpurchasedate', date('d-m-Y', strtotime((string) $productpurchase->productpurchasedate)))?>" >
                        <span class="text-red">
                    ...
                    <table class="table table-bordered product-style" style="font-size: 16px;">
                        ...
                        <tbody id="productList">
                            <?php 
                                $totalQuantity = 0;
                                $totalSubtotal = 0;
                                if(customCompute($productpurchaseitems)) {
                                    $i=1; 
