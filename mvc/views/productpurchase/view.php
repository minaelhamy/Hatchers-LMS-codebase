<?php if(customCompute($productpurchase)) { ?>
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                ...
                <?php if(($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('usertypeID') == 5)) { ?>
                    <?php 
                        if(permissionChecker('productpurchase_edit') && ((float)$productpurchasepaid->productpurchasepaidamount == 0 && $productpurchase->productpurchaserefund == 0)) {
        ...
        <section class="content invoice" >
            ...
            <div class="row invoice-info">
                <div class="col-sm-4 invoice-col" style="font-size: 16px;">
                    ...
                    <?php if(customCompute($productsupplier)) { ?>
                        <address>
                ...
                <div class="col-sm-4 invoice-col" style="font-size: 16px;">
                    ...
                    <address>
                        ...
                        <?php if(customCompute($productwarehouse)) { ?>
                ...
                <div class="col-xs-12">
                    <div class="table-responsive">
                        <table class="table table-bordered product-style">
                            ...
                            <tbody>
                                <?php $subtotal = 0; $totalsubtotal = 0; if(customCompute($productpurchaseitems)) { $i=1; foreach ($productpurchaseitems as $productpurchaseitem) { $subtotal = ($productpurchaseitem->productpurchaseunitprice * $productpurchaseitem->productpurchasequantity); $totalsubtotal += $subtotal; ?>
                                    <tr>
                                        ...
                                        <td data-title="<?=$this->lang->line('productpurchase_unit_price')?>">
                                            <?= $productpurchaseitem->productpurchaseunitprice !== null ? number_format($productpurchaseitem->productpurchaseunitprice, 2) : '0.00' ?>
                                        </td>

                                        <td data-title="<?=$this->lang->line('productpurchase_quantity')?>">
                                            <?= $productpurchaseitem->productpurchasequantity !== null ? number_format($productpurchaseitem->productpurchasequantity, 2) : '0.00' ?>
                                        </td>
                                        <td data-title="<?=$this->lang->line('productpurchase_subtotal')?> ">
                                            <?= $subtotal !== null ? number_format($subtotal, 2) : '0.00' ?>
                                        </td>
                                    </tr>
                                <?php $i++; } } ?>
                            </tbody>
                            <tfoot>
                                <tr>
                                    ...
                                    <td><b><?= $totalsubtotal !== null ? number_format($totalsubtotal, 2) : '0.00'?></b></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><b><?= $productpurchasepaid->productpurchasepaidamount !== null ? number_format($productpurchasepaid->productpurchasepaidamount, 2) : '0.00'?></b></td>
                                </tr> 
                                <tr>
                                    ...
                                    <td><b><?= ($totalsubtotal - $productpurchasepaid->productpurchasepaidamount) !== null ? number_format(($totalsubtotal - $productpurchasepaid->productpurchasepaidamount), 2) : '0.00'?></b></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                ...
                <div class="col-sm-3 col-xs-12 pull-right">
                    <div class="well well-sm">
                        <p>
                            ...
                            <br>
                            <?=$this->lang->line('productpurchase_date')?> : <?=date('d M Y', strtotime((string) $productpurchase->create_date))?>
                        </p>
                    </div>
                </div>
            </div>
