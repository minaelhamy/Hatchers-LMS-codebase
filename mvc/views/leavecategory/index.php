            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tbody>
                            <?php if(customCompute($leave_categories)) {$i = 1; foreach($leave_categories as $leavecategory) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('leavecategory_category')?>">
                                        <?php
                                            if (strlen((string) $leavecategory->leavecategory) > 25) {
    echo strip_tags(substr((string) $leavecategory->leavecategory, 0, 25)."...");
} else {
    echo strip_tags(substr((string) $leavecategory->leavecategory, 0, 25));
}
                                        ?>
