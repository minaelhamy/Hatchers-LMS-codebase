            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_markpercentage")?>" >
                        </div>
                    </div>
                ...
                <?php if ($siteinfos->note==1) { ?>
                    <div class="callout callout-danger">
                        <p><b>Note:</b> After adding a new mark percentage select this percentage in mark settings to activate this new percentage on marking.</p>
                    </div>
                <?php } ?>
