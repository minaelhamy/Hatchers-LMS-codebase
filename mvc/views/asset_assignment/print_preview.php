      ...
      <div class="areaTop">
        ...
        <div class="studentProfile">
          ...
          <div class="singleItem">
            ...
            <div class="single_value">: <?php if($users->dob) { echo date("d M Y", strtotime((string) $users->dob)); } ?></div>
          </div>
          <div class="singleItem">
      ...
      <div class="areaBottom">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td> <?=isset($asset_assignment->due_date) ?  date('d M Y', strtotime((string) $asset_assignment->due_date)) : ''; ?></td>
            </tr>
            <tr>
                <td width="30%"><?=$this->lang->line("asset_assignment_check_out_date")?></td>
                <td> <?=isset($asset_assignment->check_out_date) ? date('d M Y', strtotime((string) $asset_assignment->check_out_date)) : ''?></td>
            </tr>
            <tr>
                <td width="30%"><?=$this->lang->line("asset_assignment_check_in_date")?></td>
                <td> <?=isset($asset_assignment->check_in_date) ? date('d M Y', strtotime((string) $asset_assignment->check_in_date)) : '';?></td>
            </tr>
            <tr>
