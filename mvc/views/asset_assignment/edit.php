                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php if($asset_assignment->due_date != null) { ?>
                                <input type="text" class="form-control" id="due_date" name="due_date" value="<?=set_value('due_date', date("d-m-Y", strtotime((string) $asset_assignment->due_date)))?>" >
                            <?php } else { ?>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php if($asset_assignment->check_out_date != null) { ?>
                                <input type="text" class="form-control" id="check_out_date" name="check_out_date" value="<?=set_value('check_out_date', date("d-m-Y", strtotime((string) $asset_assignment->check_out_date)))?>" >
                            <?php } else { ?>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php if($asset_assignment->check_in_date != null) { ?>
                                <input type="text" class="form-control" id="check_in_date" name="check_in_date" value="<?=set_value('check_in_date', date("d-m-Y", strtotime((string) $asset_assignment->check_in_date)))?>" >
                            <?php } else { ?>
