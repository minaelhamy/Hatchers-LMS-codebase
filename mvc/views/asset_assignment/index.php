                            ...
                            <?php if(customCompute($asset_assignments)) {$i = 1; foreach($asset_assignments as $asset_assignment) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('asset_assignment_due_date')?>">
                                        <?php echo isset($asset_assignment->due_date) ? date('d M Y', strtotime((string) $asset_assignment->due_date)) : ''; ?>
                                    </td>
                                    <td data-title="<?=$this->lang->line('asset_assignment_check_out_date')?>">
                                        <?php echo isset($asset_assignment->check_out_date) ? date('d M Y', strtotime((string) $asset_assignment->check_out_date)) : ''; ?>
                                    </td>
                                    <td data-title="<?=$this->lang->line('asset_assignment_check_in_date')?>">
                                        <?php echo isset($asset_assignment->check_in_date) ? date('d M Y', strtotime((string) $asset_assignment->check_in_date)) : ''; ?>
                                    </td>
