                    ...
                    <table class="table table-bordered">
                        <?php 
                            ...
                            if (isset($make_payment->total_hours)) {
                                ...
                                <tr>
                                    <td>
                                <?=$this->lang->line("make_payment_salary_grades")?>
                                </td>
                                    <td> 
                                ...
                                <tr>
                                    <td>
                                <?=$this->lang->line("make_payment_hourly_rate")?>
                                </td>
                                    <td>
                        ...
                        <?php 
                            } elseif ($make_payment->salaryID == 1) {
                                ?>
                            <tr>
                                <td>
                                <?=$this->lang->line("make_payment_salary_grades")?>
                            ...
                            <tr>
                                <td>
                                <?=$this->lang->line("make_payment_basic_salary")?>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                <?=$this->lang->line("make_payment_overtime_rate")?>
                                </td>
                                <td>
                        ...
                        <tr>
                            ...
                            <td><?=date('d M Y', strtotime((string) $make_payment->create_date))?></td>
                        </tr>
                        ...
                        <?php if($make_payment->salaryID == 1) { ?>
                            ...
                            <?php 
                                if(customCompute($salaryoptions)) {
                                    ...
                                    $max = max($allowanceVal, $deductionVal); ?>
