<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_leaveassign')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
    ...
    echo "<div class='form-group' >";
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                $array[0] = $this->lang->line('leaveassign_select_usertype');
                                ...
                                echo form_dropdown("usertypeID", $array, set_value("usertypeID"), "id='usertypeID' class='form-control select2'");
                            ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                if(customCompute($leavecategorys)) {
                                    foreach ($leavecategorys as $leavecategory) {
                                        $leavecategoryArray[$leavecategory->leavecategoryID] = $leavecategory->leavecategory;
                                    }
                                }
                                echo form_dropdown("leavecategoryID", $leavecategoryArray, set_value("leavecategoryID"), "id='leavecategoryID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input step="1" type="number" class="form-control" id="leaveassignday" name="leaveassignday" value="<?=set_value('leaveassignday')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_leaveassign")?>" >
                        </div>
                    </div>
                </form>
            </div>
