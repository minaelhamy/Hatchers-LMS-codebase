                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        <label for="hname" class="col-sm-2 control-label">
                            <?=$this->lang->line("category_hname")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                $array = array();
                                ...
                                echo form_dropdown("hname", $array, set_value("hname", $category->hostelID), "id='hname' class='form-control select2'");
                            ?>
                    ...
                    ?>
                        <label for="class_type" class="col-sm-2 control-label">
                            <?=$this->lang->line("category_class_type")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="hbalance" class="col-sm-2 control-label">
                            <?=$this->lang->line("category_hbalance")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
