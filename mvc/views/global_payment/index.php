                                ...
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(customCompute($single_classes)) { echo $single_classes->classes; } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(customCompute($single_section)) { echo $single_section->section; } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tbody>
                                            <?php $invoice_total = 0; $invoice_weaver = 0; $invoice_fine = 0; $invoice_paid_fine = 0; if(customCompute($globalpayments)) { foreach ($globalpayments as $globalpayment) { ?>
                                                ...
                                                <?php
                                                    $tpaid = 0;
                                                    $tfine = 0;
                                                    if (isset($paidpayments['paid'][$globalpayment->globalpaymentID]) && $paidpayments['paid'][$globalpayment->globalpaymentID] > 0) {
                                                        $invoice_total += $paidpayments['paid'][$globalpayment->globalpaymentID];
                                                        $tpaid = $paidpayments['paid'][$globalpayment->globalpaymentID];
                                                    }

                                                    if(isset($paidpayments['weaver'][$globalpayment->globalpaymentID]) && $paidpayments['weaver'][$globalpayment->globalpaymentID] > 0) {
                                                        $invoice_weaver += $paidpayments['weaver'][$globalpayment->globalpaymentID];    
                                                    }

                                                    if (isset($paidpayments['fine'][$globalpayment->globalpaymentID]) && $paidpayments['fine'][$globalpayment->globalpaymentID] > 0) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=$tpaidandfine?></td>
                                                    <td><?=ucfirst((string) $globalpayment->clearancetype)?></td>
                                                    <td><?=isset($paidpayments['paiddate'][$globalpayment->globalpaymentID]) ? date('d-M-Y', strtotime((string) $paidpayments['paiddate'][$globalpayment->globalpaymentID])) : '' ?></td>
                                                    <td>
                            ...
                            <table class="table table-striped table-bordered" style="margin-top: 10px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control" id="invoicenumber" type="text" name="invoicenumber" value="INV-G-<?=(customCompute($globalpayment_max) > 0) ? $globalpayment_max->globalpaymentID+1 : '1'?>" readonly></td>
                        ...
                        <div class="assign-fee-payment">
                            ...
                            <table class="table info">
                                <tr>
                                    ...
                                    <td><b><?=$this->lang->line('global_clearance')?>: </b><?=strtoupper((string) $globalpayment->clearancetype)?></td>
                                    <td><b><?=$this->lang->line('global_date')?>: </b><?=isset($paidpayments['paiddate'][$globalpayment->globalpaymentID]) ? date('d-M-Y', strtotime((string) $paidpayments['paiddate'][$globalpayment->globalpaymentID])) : '' ?></td>
                                </tr>
                                <tr>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php if(customCompute($weaverandfines) && customCompute($paymenteds)) { foreach ($paymenteds as $paymented) { ?>
                                        <?php if($globalpayment->globalpaymentID == $paymented->globalpaymentID) { ?>
                                    ...
                                    <?php $paymentedFineAmount = 0; $paymentedFineStatus = FALSE; if(customCompute($weaverandfines) && customCompute($paymenteds)) { foreach ($paymenteds as $paymented) { ?>
                                        <?php if($globalpayment->globalpaymentID == $paymented->globalpaymentID) { ?>
                                    ...
                                    <?php $paymentedWeaverAmount = 0; $paymentedWeaverStatus = FALSE; if(customCompute($weaverandfines) && customCompute($paymenteds)) { foreach ($paymenteds as $paymented) { ?>
                                        <?php if($globalpayment->globalpaymentID == $paymented->globalpaymentID) { ?>
