<?php if(customCompute($productsale)) { ?>
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                ...
                <?php if(($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('usertypeID') == 5)) { ?>
                    <?php 
                        if(permissionChecker('productsale_edit') && ((float)$productsalepaid->productsalepaidamount == 0 && $productsale->productsalerefund == 0)) {
                ...
                <div class="col-sm-3 col-xs-12 pull-right">
                    <div class="well well-sm">
                        <p>
                            ...
                            <br>
                            <?=$this->lang->line('productsale_date')?> : <?=date('d M Y', strtotime((string) $productsale->create_date))?>
                        </p>
                    </div>
                </div>
            </div>
