                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                ?>" class="user-logo" alt="" />
                                <span>
                                    <?=(strlen((string) $this->session->userdata('name')) > 10) ? substr((string) $this->session->userdata('name'), 0, 10) : $this->session->userdata('name')?>
                                    <i class="caret"></i>
                                </span>   
                            </a>
