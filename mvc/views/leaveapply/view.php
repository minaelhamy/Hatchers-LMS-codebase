		...
		<div class="row">
			<div class="col-sm-6">
	          	...
	          	<?php if(($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) { ?>
		          	<?php if(($leaveapply->status == null || $leaveapply->status == 0) && permissionChecker('leaveapply_edit')) { echo btn_sm_edit('leaveapply/edit/'.$leaveapply->leaveapplicationID, $this->lang->line('edit')); }
		          	?>
	          	<?php } ?>
        ...
        <div class="row">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <?php } else { ?>
                                ...
                                <li class="list-group-item" style="background-color: #FFF">
                                    <b><?=$this->lang->line('leaveapply_dob')?></b> <a class="pull-right"><?=date('d M Y',strtotime((string) $applicant->dob))?></a>
                                </li>
                                <li class="list-group-item" style="background-color: #FFF">
                                    <b><?=$this->lang->line('leaveapply_phone')?></b> <a class="pull-right"><?=$applicant->phone?></a>
                                </li>
            ...
            <div class="col-sm-6 col-mergin">
              	<div class="box box-primary box-height">
                	<div class="box-body box-profile">
                    	<h5><?=$this->lang->line('leaveapply_date')?> - <?=date('d M Y',strtotime((string) $leaveapply->apply_date));?></h5>
              	...
              	<div class="box box-primary">
                	<div class="box-body box-profile">
                  		<div class="single_box">
                    		...
                    		<p class="text-muted"><?=date("d M Y",strtotime((string) $leaveapply->from_date));?> - <?=date("d M Y",strtotime((string) $leaveapply->to_date));?></p>
                  		</div>
	                  	<div class="single_box">
	                  	...
	                  	<div class="single_box">
	                    	<strong><?=$this->lang->line('leaveapply_attachment')?></strong>
	                    	<p class="text-muted">
                                <?php
                                if($leaveapply->attachmentorginalname) { 
                                	echo btn_download_file('leaveapply/download/'.$leaveapply->leaveapplicationID, namesorting($leaveapply->attachmentorginalname, 12), $this->lang->line('download'));
                                }
                                ?>
	                    	</p>
	                  	</div>
