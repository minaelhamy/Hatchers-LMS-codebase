                        ...
                        <div class="studentProfile">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="singleItem">
                                    ...
                                    <div class="single_value">: <?=date('d M Y',strtotime((string) $applicant->dob))?></div>
                                </div>
                                <div class="singleItem">
                                    <div class="single_label"><?=$this->lang->line('leaveapply_phone')?></div>
                                    <div class="single_value">: <?=$applicant->phone?></div>
                    ...
                    <div class="areaBottom">
                        <div class="bottomInfo">
                            <div class="singleItem">
                                ...
                                <div class="single_value">: <?=date("d M Y",strtotime((string) $leaveapply->apply_date));?></div>
                            </div>
                            <div class="singleItem">
                                <div class="single_label"><?=$this->lang->line('leaveapply_schedule')?></div>
                                <div class="single_value">: <?=date("d M Y",strtotime((string) $leaveapply->from_date));?> - <?=date("d M Y",strtotime((string) $leaveapply->to_date));?></div>
                            </div>
                            <div class="singleItem">
