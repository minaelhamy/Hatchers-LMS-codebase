<?php $date = date('m/d/y', strtotime((string) $leaveapplication->from_date)).' - '. date('m/d/y', strtotime((string) $leaveapplication->to_date));?>
<div class="box">
    ...
    echo "<div class='form-group' >";
                    ...
                    <div class='form-group <?=form_error('applicationto_userID') ? "has-error" : "";?>' >
                        ...
                        <div class="col-sm-6">
                            <?php
                                $userArray = customCompute($users) ? $users : ['0' => $this->lang->line('leaveapply_select_user')];
