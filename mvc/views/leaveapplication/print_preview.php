            ...
            <div class="areaBottom">
                <div class="bottomInfo">
                    <div class="singleItem">
                        ...
                        <div class="single_value">: <?=date("d M Y",strtotime((string) $leaveapplication->apply_date));?></div>
                    </div>
                    <div class="singleItem">
                        <div class="single_label"><?=$this->lang->line('leaveapplication_schedule')?></div>
                        <div class="single_value">: <?=date("d M Y",strtotime((string) $leaveapplication->from_date));?> - <?=date("d M Y",strtotime((string) $leaveapplication->to_date));?></div>
                    </div>
                    <div class="singleItem">
