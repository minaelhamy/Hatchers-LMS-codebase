<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_manage_salary')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
    ...
    echo "<div class='form-group' >";
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("salary", $array, set_value("salary", $manage_salary->salary), "id='salary' class='form-control select2'");
                            ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("template", $array, set_value("template", $manage_salary->template), "id='template' class='form-control select2'");
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_salary_template")?>" >
                        </div>
                    </div>
                </form>
            </div>
