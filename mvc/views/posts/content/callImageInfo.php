...
<div class="attached-form">
    <form id="fromImageDataSubmit">
        ...
        <div class="form-group hide">
            <label for="file_artist"><?=$this->lang->line('posts_artist')?></label>
        ...
        <div class="form-group hide">
            <label for="file_album"><?=$this->lang->line('posts_album')?></label>
        ...
        <div class="form-group">
            <label for="file_caption"><?=$this->lang->line('posts_caption')?></label>
        ...
        <div class="form-group">
            <label for="file_alt_text"><?=$this->lang->line('posts_alt_text')?></label>
        ...
        <div class="form-group">
            <label for="file_description"><?=$this->lang->line('posts_description')?></label>
