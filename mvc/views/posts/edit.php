<form method="POST">
    <div class="row">
        <div class="col-md-8">
            <div class="add--page--wrap">
                <h3><?=$this->lang->line('posts_edit_page')?></h3>

                <div class="form-group <?=form_error('title') ? 'has-error' : '' ?>">
                    <input type="text" id="title" value="<?=set_value('title', $post->title)?>" name="title" class="form-control" placeholder="<?=$this->lang->line('posts_enter_title_here')?>">
                ...
                <div class="form-group has-error">
                    ...
                    <textarea id="write-content" name="content"><?=set_value('content', $post->content)?></textarea>
                ...
                <div class="bg-white mb-15">
                    ...
                    <div class="sidebar-body" id="publish-box">
                        <div class="save-preview-btn clearfix">
                            <button type="submit" id="preview" class="save-preview-btn pull-right clearfix" value="preview" name="submit"><?=$this->lang->line('posts_preview_changes')?></button>
    ...
    echo $this->lang->line('posts_published');
}
                                ?>
                            ...
                            <div class="post-status-select" id="draft-edit-show">
                                <?php 
                                    $statusArray = array(
                                        'published' => $this->lang->line('posts_published'),
                                        'review' => $this->lang->line('posts_pending_review'),
                                        'draft' => $this->lang->line('posts_draft')
                                    );
                                    echo form_dropdown("status", $statusArray, set_value("status", pageStatus($post->status, FALSE)), "id='status'"); 
                                ?>
                        ...
                        <div class="post-status">
                            ...
                            <div class="post-status-select" id="publish-edit-show">
                                <?php
                                    ...
                                    echo form_dropdown("publish_month", $monthArray, set_value("publish_month", date("m", strtotime((string) $post->publish_date))), "id='publish_month' class='".$addClass."'"); 
                                ?>
                                <label class="sr-only">Day</label>
                                <input id="publish_day" name="publish_day" type="text" value="<?=set_value('publish_day', date("d", strtotime((string) $post->publish_date)))?>" size="2" class="<?=$addClass?>" maxlength="2">
                                <label class="sr-only">year</label>
                                <input id="publish_year" name="publish_year" type="text" value="<?=set_value('publish_year', date("Y", strtotime((string) $post->publish_date)))?>" size="4" class="<?=$addClass?>" maxlength="4">
                                <span>@</span>
                                <input id="publish_hour" name="publish_hour" type="text" value="<?=set_value('publish_hour', date("H", strtotime((string) $post->publish_date)))?>" size="2" class="<?=$addClass?>" maxlength="2">
                                <span>:</span>
                                <input id="publish_minute" name="publish_minute" type="text" value="<?=set_value('publish_minute', date("i", strtotime((string) $post->publish_date)))?>" size="2" class="<?=$addClass?>" maxlength="2">
                    ...
                    <div id="publish-box-footer" class="publish-btn text-right">
                        <input type="submit" name="submit" value="<?=$this->lang->line('posts_update')?>">
                    </div>
                </div>
                ...
                <div class="bg-white mb-15">
                    ...
                    <div class="sidebar-body" id="category-box">
                        <div class="">
                            ...
                            ?>
                                    <div class="form-group ini-dis-flex">
                                        <input id="<?=$posts_categorie->posts_categories?>" class="categories" name="categories[]" value="<?=$posts_categorie->posts_categoriesID?>" type="checkbox"  <?php if(customCompute($send_category) && in_array($posts_categorie->posts_categoriesID, $send_category)) { echo 'checked'; } ?> >
                ...
                <div class="bg-white mb-15">
                    ...
                    <div class="sidebar-body" id="featuredimage-box">
                        ...
                        <input type="text" id="featured_image" name="featured_image" class="hide" value="<?=set_value('featured_image', $post->featured_image)?>">
                        <span class="featured-image-btn <?=customCompute($send_featured_image) ? 'hide' : ''?>" data-toggle="modal" data-target="#SetFeaturedImage" id="set-featured-img"><?=$this->lang->line('posts_set_featured_image')?></span>
                        <span class="featured-image-btn <?=customCompute($send_featured_image) ? '' : 'hide'?>" onclick="removeFeatureImage(this, 'featured_image', 'feauret-img-show')"  id="remove-set-featured-img"><?=$this->lang->line('posts_remove_featured_image')?></span>
                    </div>
                </div>
    ...
    (function($) {
        ...
        $('.save-post-status').click(function(e) {
            ...
            if(id == 'save-status') {
                ...
                } else if(saveStatusValue == 'published') {
                    saveStatusValue = "<?=$this->lang->line('posts_published')?>";
                    btnSaveStatus = "published";
                }
