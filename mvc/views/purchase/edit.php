<div class="box">
    ...
    echo "<div class='form-group' >";
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="purchase_date" name="purchase_date" value="<?=set_value('purchase_date', isset($purchase->purchase_date) ? date("d-m-Y", strtotime((string) $purchase->purchase_date)) : '')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="service_date" name="service_date" value="<?=set_value('service_date', isset($purchase->service_date) ? date("d-m-Y", strtotime((string) $purchase->service_date)) : '' )?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="expire_date" name="expire_date" value="<?=set_value('expire_date', isset($purchase->expire_date) ? date("d-m-Y", strtotime((string) $purchase->expire_date)) : '')?>">
                        </div>
                        <span class="col-sm-4 control-label">
