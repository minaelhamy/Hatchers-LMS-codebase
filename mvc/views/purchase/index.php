                            ...
                            <?php if(customCompute($purchases)) {$i = 1; foreach($purchases as $purchase) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('purchase_date')?>">
                                        <?php echo isset($purchase->purchase_date) ? date("d M Y", strtotime((string) $purchase->purchase_date)) : ''; ?>
                                    </td>
                                    <td data-title="<?=$this->lang->line('purchase_service_date')?>">
                                        <?php echo isset($purchase->service_date) ? date("d M Y", strtotime((string) $purchase->service_date)) : ''; ?>
                                    </td>
                                    <td data-title="<?=$this->lang->line('purchase_expire_date')?>">
                                        <?php echo isset($purchase->expire_date) ? date("d M Y", strtotime((string) $purchase->expire_date)) : ''; ?>
                                    </td>
