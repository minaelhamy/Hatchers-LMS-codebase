<div class="box" style="margin-bottom:40px;">
    ...
    echo "<div class='form-group' >";
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="name" name="name" value="<?=set_value('name', $certificate_template->name)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                echo form_dropdown("theme", $buildinThemes, set_value("theme", $certificate_template->theme), "id='theme' class='form-control'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control txtDropTarget" id="main_middle_text" name="main_middle_text" style="height: 20px;"><?=set_value('main_middle_text', $certificate_template->main_middle_text)?></textarea>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control txtDropTarget" id="top_heading_title" name="top_heading_title" style="height: 20px;"><?=set_value('top_heading_title', $certificate_template->top_heading_title)?></textarea>
                        </div>
                        <span class="col-sm-10 col-sm-offset-2 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control txtDropTarget" id="top_heading_left" name="top_heading_left" style="height: 20px;"><?=set_value('top_heading_left', $certificate_template->top_heading_left)?></textarea>
                        </div>
                        <span class="col-sm-10 col-sm-offset-2 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control txtDropTarget" id="  top_heading_middle" name="  top_heading_middle" style="height: 20px;"><?=set_value('top_heading_middle', $certificate_template->top_heading_middle)?></textarea>
                        </div>
                        <span class="col-sm-10 col-sm-offset-2 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control txtDropTarget" id="  top_heading_right" name="  top_heading_right" style="height: 20px;"><?=set_value('top_heading_right', $certificate_template->top_heading_right)?></textarea>
                        </div>
                        <span class="col-sm-10 col-sm-offset-2 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control txtDropTarget" id="template" name="template" ><?=set_value('template', $certificate_template->template)?></textarea>
                        </div>
                        <span class="col-sm-10 col-sm-offset-2 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control txtDropTarget" id="footer_left_text" name="footer_left_text" ><?=set_value('footer_left_text', $certificate_template->footer_left_text)?></textarea>
                        </div>
                        <span class="col-sm-10 col-sm-offset-2 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control txtDropTarget" id="footer_middle_text" name="footer_middle_text" ><?=set_value('footer_middle_text', $certificate_template->footer_middle_text)?></textarea>
                        </div>
                        <span class="col-sm-10 col-sm-offset-2 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control txtDropTarget" id="footer_right_text" name="footer_right_text" ><?=set_value('footer_right_text', $certificate_template->footer_right_text)?></textarea>
                        </div>
                        <span class="col-sm-10 col-sm-offset-2 control-label">
