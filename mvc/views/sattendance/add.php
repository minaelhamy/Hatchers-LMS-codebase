            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody id="list">
                            <?php if(customCompute($students)) {$i = 1; foreach($students as $student) { if(isset($attendances[$student->studentID])) { ?>
                                <tr>
                                    ...
                                    <td class="studentID" data-studentid="<?=$student->studentID?>" data-title="<?=$this->lang->line('attendance_attendance')?>">
                                        <?php
                                            ...
                                            if(isset($attendances[$student->studentID])) {
                                                ...
                                                } elseif ($monthyear == $attendances[$student->studentID]->monthyear && $attendances[$student->studentID]->studentID == $student->srstudentID && $attendances[$student->studentID]->classesID == $student->srclassesID) {
                                                    $pmethod = '';
                                                    $lemethod = '';
                                                    $lmethod = '';
                                                    $amethod = '';
