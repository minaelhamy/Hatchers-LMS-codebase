      ...
      <div class="areaTop">
        ...
        <div class="studentProfile">
          ...
          <div class="singleItem">
            ...
            <div class="single_value">: <?=customCompute($usertype) ? $usertype->usertype : '' ?></div>
          </div>
          <div class="singleItem">
          ...
          <div class="singleItem">
            ...
            <div class="single_value">: <?=customCompute($class) ? $class->classes : ''?></div>
          </div>
          <div class="singleItem">
              ...
              if(customCompute($subjects)) {
                    foreach ($subjects as $subject) {
                      ...
                      <div class="totalattendanceCount">
                          ...
                          <?=$this->lang->line('sattendance_total_holiday')?>
                          :
                          <?=$holidayCount?>
                          , 
                          
                          <?=$this->lang->line('sattendance_total_weekenday')?>
                          :
                          <?=$weekendayCount?>
                          , 
                          
                          <?=$this->lang->line('sattendance_total_leaveday')?>
                          :
                          <?=$leavedayCount?>
                          , 
                          
                          <?=$this->lang->line('sattendance_total_present')?>
                          :
                          <?=$presentCount?>
                          , 
                          
                          <?=$this->lang->line('sattendance_total_latewithexcuse')?>
                          :
                          <?=$lateexcuseCount?>
                          , 
                          
                          <?=$this->lang->line('sattendance_total_late')?>
                          :
                          <?=$lateCount?>
                          , 
                          
                          <?=$this->lang->line('sattendance_total_absent')?>
                          :
                          <?=$absentCount?>
                      </div>
                    <?php 
                      } elseif ($subject->subjectID == $student->sroptionalsubjectID) {
                          ?>
