                   ...
                   <?php 
                    ...
                    ?>
                        <label for="author" class="col-sm-2 control-label">
                            <?=$this->lang->line("book_author")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="price" class="col-sm-2 control-label">
                            <?=$this->lang->line("book_price")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="rack" class="col-sm-2 control-label">
                            <?=$this->lang->line("book_rack_no")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
