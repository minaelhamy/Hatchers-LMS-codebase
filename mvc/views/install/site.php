<div class="panel panel-default">
    <div class="panel-heading-install">
		<ul class="nav nav-pills">
		  	...
		  	<li><a href="<?=base_url('install/purchasecode')?>"><span class="fa fa-check"></span>License Code</a> </li>
		  	<li><a href="<?=base_url('install/database')?>"><span class="fa fa-check"></span> Database</a></li>
            <li><a href="<?=base_url('install/timezone')?>"><span class="fa fa-check"></span> Time Zone</a></li>
