...
class Make_payment extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $setrole = htmlentities((string) escapeString($this->uri->segment(3)));
    ...
    public function add() {
        ...
        if(permissionChecker('make_payment')) {
            ...
            if((int)$userID && (int) $usertypeID) {
                ...
                $this->make_payment_m->order('month DESC');
    ...
    public function view() {
        if(permissionChecker('make_payment')) {
            ...
            if((int)$id !== 0) {
                ...
                if(customCompute($this->data['make_payment'])) {
                    ...
                    if((int)$userID && (int) $usertypeID) {
                        ...
                        if(customCompute($user)) {
                            ...
                            if(customCompute($manageSalary)) {
                                ...
                                if(customCompute($this->data['persent_salary_template'])) {
                                    if($this->data['make_payment']->salaryID == 1) {
                                        ...
                                        if(customCompute($this->data['salary_template'])) {
                                            $this->db->order_by("salary_optionID", "asc");
