 ...
 public function __construct() {
	...
	public function pdf() {
		if(permissionChecker('duefeesreport')) { 
			...
			$feetypeID = htmlentities((string) escapeString($this->uri->segment(6)));
		...
		if(customCompute($getDueFeesReports)) {
	        ...
	        foreach($getDueFeesReports as $getDueFeesReport) {
	        	if($sectionID > 0) { if(isset($students[$getDueFeesReport->studentID]) && $students[$getDueFeesReport->studentID]->srsectionID == $sectionID) { 
		        	...
		        	$getDueFeesReportArrays[$i][] = date('d M Y',strtotime((string) $getDueFeesReport->create_date));
		        	...
		        	if ($classesID == 0 && isset($students[$getDueFeesReport->studentID])) {
               ...
               $getDueFeesReportArrays[$i][] = isset($classes[$stclassID]) ? $classes[$stclassID] : '';
	                ...
	                if ($sectionID == 0 && isset($students[$getDueFeesReport->studentID])) {
	        ...
	        //Make Here Xml Body
	        $row  = 3;
	        if(customCompute($getDueFeesReportArrays)) {
