...
*/
  ...
  } elseif ($this->input->post("gradefrom") != '') {
  ...
  } elseif ($this->input->post("gradeupto") != '') {
	...
	public function gradefrom_grater() {
		if ($this->input->post("gradefrom") != '' && $this->input->post("gradeupto") != '' && $this->input->post("gradefrom") > $this->input->post("gradeupto")) {
