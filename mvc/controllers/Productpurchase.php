...
class Productpurchase extends Admin_Controller {
    ...
    public $data;
    public $uri;
    public $productpurchase_m;
    public $productpurchaseitem_m;
    public $form_validation;
    public $input;
    public $product_m;
    public $upload;
    public $upload_data;
    public $productpurchasepaid_m;
    public $db;
    /*
    | -----------------------------------------------------
    ...
    */
    ...
    public function delete() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('defaultschoolyearID') == 5)) {
            ...
            if((int)$id !== 0) {
                $schoolyearID = $this->session->userdata('defaultschoolyearID');
                $this->data['productpurchase'] = $this->productpurchase_m->get_single_productpurchase(array('productpurchaseID' => $id, 'schoolyearID' => $schoolyearID));
                if(customCompute($this->data['productpurchase'])) {
                    $this->data['productpurchasepaid'] = $this->productpurchasepaid_m->get_productpurchasepaid_sum('productpurchasepaidamount', array('productpurchaseID' => $id));
                    if(($this->data['productpurchase']->productpurchaserefund == 0) && ($this->data['productpurchasepaid']->productpurchasepaidamount == NULL)) {
    ...
    public function unique_productitem() {
        $productitems = json_decode((string) $this->input->post('productitem'));
        $status = FALSE;
    ...
    public function fileupload() {
        ...
        } elseif (customCompute($productpurchase)) {
    ...
    private function grandtotalandpaid($productpurchases, $schoolyearID) {
        ...
        if(customCompute($productpurchases)) {
            foreach ($productpurchases as $productpurchase) {
                if(isset($productpurchaseitems[$productpurchase->productpurchaseID]) && customCompute($productpurchaseitems[$productpurchase->productpurchaseID])) {
                ...
                if(isset($productpurchasepaids[$productpurchase->productpurchaseID]) && customCompute($productpurchasepaids[$productpurchase->productpurchaseID])) {
                ...
                if($_POST !== []) {
                    ...
                    if ($this->form_validation->run() == FALSE) {
                        ...
                        $array = array(
                            ...
                            "productpurchasedate" => date('Y-m-d', strtotime((string) $this->input->post("productpurchasedate"))),
                        ...
                        if(customCompute($productitems)) {
                            ...
                            if($updateID == 0) {
                                ...
                                $productitemschoolyearID = customCompute($updatedata) ? $updatedata->schoolyearID : $schoolyearID;
                            }
                        ...
                        if (permissionChecker('productpurchase_edit') && $updateID > 0) {
    ...
    public function paymentlist() {
        ...
        if(!empty($productpurchaseID) && (int)$productpurchaseID && $productpurchaseID > 0) {
            ...
            if(customCompute($productpurchase)) {
                ...
                if(customCompute($productpurchasepaids)) {
                    $i = 1; 
                    foreach ($productpurchasepaids as $productpurchasepaid) {
                        echo '<tr>';
                            ...
                            echo '<td data-title="'.$this->lang->line('productpurchase_date').'">';
                                echo date('d M Y', strtotime((string) $productpurchasepaid->productpurchasepaiddate));
                            echo '</td>';
                            ...
                            if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('defaultschoolyearID') == 5)) {
                                echo '<td data-title="'.$this->lang->line('action').'">';
                                    if($productpurchase->productpurchaserefund == 0 && permissionChecker('productpurchase_delete')) {
    ...
    public function deletepurchasepaid() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('defaultschoolyearID') == 5)) {
            $productpurchasepaidID = htmlentities((string) escapeString($this->uri->segment(3)));
            $schoolyearID = $this->session->userdata('defaultschoolyearID');
            
            if(permissionChecker('productpurchase_delete')) {
                if((int)$productpurchasepaidID !== 0) {
                    ...
                    if(customCompute($productpurchasepaid)) {
                        ...
                        if(customCompute($productpurchase) && $productpurchase->productpurchaserefund == 0) {
    ...
    public function getpurchaseinfo() {
        ...
        if (permissionChecker('productpurchase_add') && (!empty($productpurchaseID) && (int)$productpurchaseID && $productpurchaseID > 0)) {
            $productpurchase = $this->productpurchase_m->get_single_productpurchase(array('productpurchaseID' => $productpurchaseID, 'schoolyearID' => $schoolyearID));
            if (customCompute($productpurchase) && ($productpurchase->productpurchaserefund == 0 && $productpurchase->productpurchasestatus != 2)) {
                    ...
                    if($_POST !== []) {
                        ...
                        if ($this->form_validation->run() == FALSE) {
                            ...
                            $array = array(
                                ...
                                'productpurchaseID' => $this->input->post('productpurchaseID'),
                                'productpurchasepaiddate' => date('Y-m-d', strtotime((string) $this->input->post("productpurchasepaiddate"))), 
