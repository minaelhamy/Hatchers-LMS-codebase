...
class Productsale extends Admin_Controller {
    ...
    public $parents_m;
    public $user_m;
    public $productsaleitem_m;
    public $productsalepaid_m;
    public $uri;
    public $productsale_m;
    ...
    */
    ...
    private function grandtotalandpaid($productsales, $schoolyearID) {
        ...
        if(customCompute($productsaleKey)) {
            ...
            if(customCompute($productsales)) {
                foreach ($productsales as $productsale) {
                    if(isset($productsaleitems[$productsale->productsaleID]) && customCompute($productsaleitems[$productsale->productsaleID])) {
                    ...
                    if(isset($productsalepaids[$productsale->productsaleID]) && customCompute($productsalepaids[$productsale->productsaleID])) {
    ...
    public function paymentlist() {
        ...
        if (customCompute($productsale) && (!empty($productsaleID) && (int)$productsaleID && $productsaleID > 0)) {
                ...
                foreach ($productsalepaids as $productsalepaid) {
                    echo '<tr>';
                        ...
                        echo '<td data-title="'.$this->lang->line('productsale_date').'">';
                            echo date('d M Y', strtotime((string) $productsalepaid->productsalepaiddate));
                        echo '</td>';
                        ...
                        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('defaultschoolyearID') == 5)) {
                            echo '<td data-title="'.$this->lang->line('action').'">';
                                if($productsale->productsalerefund == 0 && permissionChecker('productsale_delete')) {
    ...
    public function deletesalepaid() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('defaultschoolyearID') == 5)) {
            $productsalepaidID = htmlentities((string) escapeString($this->uri->segment(3)));
            $schoolyearID = $this->session->userdata('defaultschoolyearID');
            
            if(permissionChecker('productsale_delete')) {
                if((int)$productsalepaidID !== 0) {
    ...
    public function getsaleinfo() {
        ...
        if (permissionChecker('productsale_add') && (!empty($productsaleID) && (int)$productsaleID && $productsaleID > 0)) {
            $productsale = $this->productsale_m->get_single_productsale(array('productsaleID' => $productsaleID, 'schoolyearID' => $schoolyearID));
            if (customCompute($productsale) && ($productsale->productsalerefund == 0 && $productsale->productsalestatus != 3)) {
                    ...
                    if($_POST !== []) {
                        ...
                        if ($this->form_validation->run() == FALSE) {
                            ...
                            $array = array(
                                ...
                                'productsaleID' => $this->input->post('productsaleID'),
                                'productsalepaiddate' => date('Y-m-d', strtotime((string) $this->input->post("productsalepaiddate"))), 
            ...
            if((int)$id !== 0) {
                ...
                if(customCompute($this->data['productsale'])) {
                    ...
                    if($this->data['productsale']->productsalecustomertypeID == 3) {
                        ...
                        $this->data['classesID'] = customCompute($srstudent) ? $srstudent->srclassesID : 0;
                    } else {
    ...
    public function getuser() {
        ...
        if((int)$productsalecustomertypeID !== 0) {
    ...
    public function unique_productitemadjust() {
        ...
        if(customCompute($productitems)) {
            foreach ($productitems as $productitem) {
                if($productitem->unitprice != '' && $productitem->quantity != '') {
                    if(strlen((string) $productitem->unitprice) <= 15 && strlen((string) $productitem->quantity) <= 15) {
    ...
    public function fileupload() {
        ...
        } elseif (customCompute($productsale)) {
                ...
                if($_POST !== []) {
                    ...
                    if ($this->form_validation->run() == FALSE) {
                        ...
                        $array = array(
                            ...
                            "productsaledate" => date('Y-m-d', strtotime((string) $this->input->post("productsaledate"))),
                            ...
                            if($updateID == 0) {
                                if($this->input->post('productsalepaymentstatusID') > 1) {
                                    ...
                                    $productsalepaidArray = array(
                                        ...
                                        'schoolyearID' =>  $this->session->userdata('defaultschoolyearID'),
                                        'productsaleID' => $productsaleID,
                                        'productsalepaiddate' => date('Y-m-d', strtotime((string) $this->input->post("productsaledate"))),
                                        'productsalepaidreferenceno' => $this->input->post("productsalepaidreferenceno"),
                                        'productsalepaidamount' => $this->input->post("productsalepaidamount"),
                                        'productsalepaidpaymentmethod' => $this->input->post("productsalepaidpaymentmethod"),
                                        'productsalepaidfile' => '',
